      ...
      {auki && (
        ...
        >
          <div style={{
            ...
            margin: '1rem', maxHeight: '90vh', overflowY: 'auto',
          }}>
            <h2 style={{
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <div>
                  ...
                  <input value={etunimi} onChange={e => setEtunimi(e.target.value)} required style={inputStyle} autoFocus />
                </div>
                <div>
                  <label style={labelStyle}>Sukunimi *</label>
                  <input value={sukunimi} onChange={e => setSukunimi(e.target.value)} required style={inputStyle} />
                </div>
              </div>
              <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <input
                  type="checkbox"
                  id="alv"
                  checked={alvRekisterissa}
                  onChange={e => setAlvRekisterissa(e.target.checked)}
                  style={{ accentColor: '#1D9E75', width: 16, height: 16 }}
                />
                <label htmlFor="alv" style={{ fontSize: '0.9rem', color: '#9ab89e', cursor: 'pointer' }}>
                  ALV-rekisterissä
                </label>
              </div>
